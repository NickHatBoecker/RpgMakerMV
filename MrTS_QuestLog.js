...
* @default - No Objectives
*
* @param Show Notification on Quest Start
* @desc Show Notification on Quest Start? True/False
* Default: True
* @default True
*
* @param New Quest Text
* @desc Text to show after a new quest was added.
* Default: New Quest: 
* @default New Quest: 
*
* @param Show Notification on Quest End
* @desc Show Notification when Quest was completed? True/False
* Default: True
* @default True
*
* @param Quest Completed Text
* @desc Text to show after a quest was completed.
...
(function() {
	...
	var paramNoObjectivesText = String(parameters['No Objective Text'] || "- No Objectives");
	
	var paramShowTextOnQuestStart = String(parameters['Show Notification on Quest Start'] || "true");
	var paramQuestStartText = String(parameters['New Quest Text'] || "New Quest: ");
	var paramShowTextOnQuestEnd = String(parameters['Show Notification on Quest End'] || "true");
	var paramQuestCompletedText = String(parameters['Quest Completed Text'] || "Quest completed: ");
	...
	Game_System.prototype.startQuest = function(id) {
		...
		if (typeof Notification !== 'undefined' && paramShowTextOnQuestStart) {
			var message = paramQuestStartText + this._quests[id].name;
	...
	Game_System.prototype.finishQuest = function(id) {
		...
		if (typeof Notification !== 'undefined' && paramShowTextOnQuestEnd) {
			var message = paramQuestCompletedText + this._quests[id].name;
			Notification.add(message);
		}
	};
